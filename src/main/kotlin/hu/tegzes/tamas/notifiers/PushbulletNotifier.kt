...
class PushbulletNotifier (val apiKey: String) {
    companion object {
        private val PUSHBULLET_API_ADDRESS = """https://api.pushbullet.com/v2/pushes"""
    }
    private val PUSHBULLET_API_ADDRESS = """https://api.pushbullet.com/v2/pushes"""
    ...
    fun sendNote(body : String,
        ...
        val bufferedWriter = connection.getOutputStream().writer()
